...
} from "~shared/engine/data/timeScale.js";
...
export const circularEffectLayout = ({
  lane,
  w,
  h,
}: { lane: number; w: number; h: number }) => {
...
export const getHitbox = (options: {
  l: number;
  r: number;
  leniency: number;
}) =>
